...
- Cree un proyecto de Angular con ng: `ng new orellanagerardo20260212.client --defaults --skip-install --skip-git --no-standalone `.
...
- Crear archivo de proyecto (`orellanagerardo20260212.client.esproj`).
